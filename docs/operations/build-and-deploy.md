...
All three crates share version `0.5.4` and edition 2021.
...
Releases are triggered by pushing a Git tag that matches `v*` (for example, `v0.5.4`). The release workflow (`.github/workflows/release.yml`) has three stages:
