...
class Krusty < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/honeycomb-Technologies/Mitsuro/releases/download/vVERSION_PLACEHOLDER/krusty-aarch64-apple-darwin.tar.gz"
      sha256 "SHA256_MACOS_ARM64"
    else
      url "https://github.com/honeycomb-Technologies/Mitsuro/releases/download/vVERSION_PLACEHOLDER/krusty-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/honeycomb-Technologies/Mitsuro/releases/download/vVERSION_PLACEHOLDER/krusty-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "SHA256_LINUX_ARM64"
    else
      url "https://github.com/honeycomb-Technologies/Mitsuro/releases/download/vVERSION_PLACEHOLDER/krusty-x86_64-unknown-linux-gnu.tar.gz"
