...
pub struct OAuthStatusUpdate {
    ...
    pub provider: mitsuro_core::ai::providers::ProviderId,
    ...
    pub token: Option<mitsuro_core::auth::OAuthTokenData>,
}
...
pub struct AsyncChannels {
    ...
    pub update_status: Option<mpsc::UnboundedReceiver<mitsuro_core::updater::UpdateStatus>>,
    ...
    pub anthropic_verifier: Option<oneshot::Receiver<mitsuro_core::auth::PkceVerifier>>,
