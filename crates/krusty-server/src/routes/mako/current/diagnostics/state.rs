use krusty_core::storage::{AutonomousTask, MakoRuntimeState, MakoRuntimeStateStatus, TaskStatus};
...
pub(in super::super) fn has_due_soon_wake(runtime: Option<&MakoRuntimeState>) -> bool {
