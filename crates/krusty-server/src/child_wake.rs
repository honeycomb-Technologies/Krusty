...
use krusty_core::storage::{Database, DelegatedRunRecord, DelegatedRunStore, SessionType};
...
mod tests {
    ...
    fn test_state() -> (AppState, tempfile::TempDir, PathBuf) {
        ...
        let state = AppState {
            ...
            hook_manager: Arc::new(RwLock::new(krusty_core::agent::UserHookManager::new())),
