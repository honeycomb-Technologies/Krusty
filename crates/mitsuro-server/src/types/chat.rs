...
use mitsuro_core::storage::{SessionType, WorkMode, WorkspaceMode};
...
mod tests {
    ...
    use mitsuro_core::storage::{RuntimeTraceEvent, WorkspaceMode};
    use serde_json::json;
    ...
    fn chat_request_accepts_provider_aware_model_key() {
        ...
        assert_eq!(key.provider, mitsuro_core::ai::providers::ProviderId::Grok);
    ...
    fn tool_result_request_accepts_permission_mode() {
        ...
        assert_eq!(
            req.permission_mode,
            Some(mitsuro_core::tools::registry::PermissionMode::Autonomous)
        );
    }
