...
use mitsuro_core::storage::{
    HiveControllerEvent, HiveRunPriority, RuntimeTraceEvent, RuntimeTraceStore, RuntimeTraceSummary,
};

use crate::error::AppError;

use super::super::HivePendingApprovalSummary;
...
pub(in super::super) struct RunTraceDiagnostics {
    ...
    pub(in super::super) pending_approvals: Vec<HivePendingApprovalSummary>,
}

pub(in super::super) fn load_run_trace_diagnostics(
    trace_store: &RuntimeTraceStore<'_>,
    session_id: &str,
    pending_approvals: Vec<HivePendingApprovalSummary>,
...
pub(in super::super) fn pending_approval_summaries_from_durable_events(
    events: &[HiveControllerEvent],
    session_id: &str,
    session_title: &str,
    project_dir: Option<&str>,
    target_branch: Option<&str>,
    priority: HiveRunPriority,
) -> Vec<HivePendingApprovalSummary> {
    events
        .iter()
        .filter_map(|event| {
            ...
            Some(HivePendingApprovalSummary {
