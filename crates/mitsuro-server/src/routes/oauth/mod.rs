...
const OAUTH_RESULT_STORAGE_KEY: &str = "mitsuro:oauth-result";
const OAUTH_RESULT_CHANNEL: &str = "mitsuro:oauth";
...
mod tests {
    ...
    use mitsuro_core::ai::providers::ProviderId;
    use mitsuro_core::auth::{OAuthTokenData, OAuthTokenStore};
