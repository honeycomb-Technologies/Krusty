...
- `MITSURO_PROVIDER` (optional): `minimax`, `openai`, `openrouter`, `zai`
- `MITSURO_MODEL` (optional): override default model for selected provider
...
of Mitsuro and bind verified principals through a dedicated server integration;
