...
impl Default for GitIdentity {
    fn default() -> Self {
        Self {
            ...
            email: "mitsuro@users.noreply.github.com".to_string(),
...
mod tests {
    ...
    fn default_identity() {
        ...
        assert_eq!(id.email, "mitsuro@users.noreply.github.com");
    ...
    fn trailer_line_format() {
        ...
        assert_eq!(
            id.trailer_line(),
            "Co-Authored-By: Mitsuro <mitsuro@users.noreply.github.com>"
        );
    }
    ...
    fn env_vars_author_mode() {
        ...
        assert!(vars.contains(&("GIT_AUTHOR_EMAIL", "mitsuro@users.noreply.github.com")));
    }
