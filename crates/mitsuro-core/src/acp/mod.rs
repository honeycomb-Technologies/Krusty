...
//!
//! This module implements the Agent Client Protocol, enabling Mitsuro to act as
...
//! ```text
//! ┌─────────────────┐     JSON-RPC 2.0      ┌─────────────────┐
//! │     Editor      │◄────── stdio ────────►│     Mitsuro      │
//! │  (ACP Client)   │                       │   (ACP Agent)   │
//! │                 │   initialize          │                 │
//! │  - Zed          │   session/new         │  MitsuroAgent    │
...
//!
//! ```rust,ignore
//! use mitsuro_core::acp::AcpServer;
//!
//! #[tokio::main]
