...
pub struct McpConfig {
    ...
    /// Local servers declared by the user in `~/.mitsuro/mcp.json` are trusted
...
///
/// Mitsuro discovers authorization-server metadata from the MCP resource URL,
...
///
/// This metadata is carried through discovery and execution. Mitsuro's central
