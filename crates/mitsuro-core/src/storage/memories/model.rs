...
pub enum MemoryNamespace {
    /// Durable knowledge shared by the owner's Hive surfaces.
    #[default]
    Shared,
    /// Knowledge specific to the primary Hive presence.
    #[serde(alias = "mako")]
    Hive,
...
impl FromStr for MemoryNamespace {
    ...
    fn from_str(value: &str) -> Result<Self, Self::Err> {
        match value {
            ...
            "hive" | crate::identity::legacy::MEMORY_NAMESPACE => Ok(Self::Hive),
            "crew" => Ok(Self::Crew),
