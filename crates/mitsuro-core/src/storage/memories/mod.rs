...
pub use model::{
    ...
    MemoryAclScope, MemoryNamespace, MemoryRevisionEvent, MemorySensitivity, MemorySource,
    MemoryStatus, MemoryType, COMPACTION_FLUSH_TITLE_PREFIX,
};
pub(crate) use store::{
    load_canonical_for_provenance_from_connection, save_canonical_in_transaction,
};
pub use store::{HiveMemoryReader, MemoryStore};
