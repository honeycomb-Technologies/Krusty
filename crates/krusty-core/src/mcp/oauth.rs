...
//! exchange, and refresh semantics. This module supplies Krusty's durable
...
/// it retryable until Krusty observes a successful exchange, while the outer
...
/// Krusty's reqwest 0.12 and WebSocket clients. Losing an initialization race
...
/// rmcp storage adapter backed by Krusty's existing atomic, owner-only
