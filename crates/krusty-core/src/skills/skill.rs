...
pub enum SkillSource {
    /// User-level skills (for example `~/.krusty/skills` or `~/.agents/skills`).
    Global,
...
pub struct SkillInfo {
    ...
    /// Human-readable discovery root (`krusty`, `agents`, `pi`, `package:foo`, ...).
    pub origin: String,
...
///
/// The Agent Skills fields are supported alongside Krusty's existing optional
