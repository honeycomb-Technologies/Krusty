...
use krusty_core::agent::user_hooks::{
    PackageHookConfig, UserHookExecutor, UserHookManager, UserHookResult, UserHookType,
};
use krusty_core::extensions::{AgentExtensionManager, ExtensionCallContext};
use krusty_core::mcp::{McpConnectionAuthority, McpManager, McpPackageConfig};
use krusty_core::plugins::{PluginManager, PluginPermission};
use krusty_core::skills::SkillsManager;
use krusty_core::tools::{ToolContext, ToolRegistry};
...
export default (krusty) => {
  ...
  krusty.registerCommand("bundle-command", {
