...
## Linux Install + Run
- Debian/Ubuntu:
  - `sudo apt install "./src-tauri/target/release/bundle/deb/Krusty Desktop_0.9.10_amd64.deb"`
- Fedora/RHEL:
  - `sudo dnf install "./src-tauri/target/release/bundle/rpm/Krusty Desktop-0.9.10-1.x86_64.rpm"`
- openSUSE:
  - `sudo zypper install "./src-tauri/target/release/bundle/rpm/Krusty Desktop-0.9.10-1.x86_64.rpm"`
