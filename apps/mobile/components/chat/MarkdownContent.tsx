...
function getStyles(t: any, isUser?: boolean) {
  ...
  return StyleSheet.create({
    ...
    paragraph: { color: textColor, fontSize: 15, lineHeight: 22, marginVertical: 4 },
    ...
    table: { borderWidth: StyleSheet.hairlineWidth, borderColor: t.border, borderRadius: 8, marginVertical: 8 },
    ...
    hr: { backgroundColor: t.border, height: StyleSheet.hairlineWidth, marginVertical: 12 },
