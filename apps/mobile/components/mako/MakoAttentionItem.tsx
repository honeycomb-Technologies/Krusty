...
import type { MakoAttentionItem as MakoAttentionFeedItem } from "./types";
import { formatProjectLabel, formatTimestamp } from "./utils";

interface MakoAttentionItemProps {
  item: MakoAttentionFeedItem;
  onOpenRun?: (runId: string) => void;
  onOpenThread: (item: MakoAttentionFeedItem) => void;
...
function kindLabel(item: MakoAttentionFeedItem): string {
  switch (item.kind) {
...
function canClear(item: MakoAttentionFeedItem): boolean {
  if (!item.active) {
    return true;
  }
...
export function MakoAttentionItem({
  item,
  onOpenRun,
  onOpenThread,
  onApprove,
