...
import type { MakoCrewRuntimeMember } from "@krusty/api";
import { useThemeContext } from "../../hooks/useTheme";
import { MakoStatusBadge } from "./MakoStatusBadge";

interface MakoCrewPickerProps {
...
function crewSummary(member: MakoCrewRuntimeMember): string {
          ...
          >
            <View style={styles.copy}>
              <View style={styles.header}>
                ...
                <MakoStatusBadge status={member.status} />
              </View>
