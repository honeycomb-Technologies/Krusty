...
interface HiveSchedulePickerProps {
  value: HiveSchedulePreset;
  onChange: (value: HiveSchedulePreset) => void;
...
export function HiveSchedulePicker({
  value,
  onChange,
