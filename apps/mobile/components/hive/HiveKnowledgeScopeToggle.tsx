...
import type { HiveKnowledgeScope } from "./types";

interface HiveKnowledgeScopeToggleProps {
  activeScope: HiveKnowledgeScope;
  workspaceDirectory?: string | null;
  allLabel: string;
  allHint: string;
  onSelect: (scope: HiveKnowledgeScope) => void;
}

export function HiveKnowledgeScopeToggle({
  activeScope,
  workspaceDirectory,
  allLabel,
  allHint,
  onSelect,
}: HiveKnowledgeScopeToggleProps) {
