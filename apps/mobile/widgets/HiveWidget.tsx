...
export interface HiveWidgetProps {
...
export function HiveWidgetView(props: HiveWidgetProps, env: WidgetEnvironment) {
  "widget";
...
export default createWidget("HiveWidget", HiveWidgetView);
